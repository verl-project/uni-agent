...
*is* the data plane (exec + file transfer + optional port tunnel). Sessions
depend only on the narrow :class:`SandboxBackend` protocol (the data-plane
subset), never on lifecycle.
