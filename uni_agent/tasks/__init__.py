...
(there is no default)::
    ...
    task = get_task("swe_bench", SWEBenchTaskConfig())  # config is required
    sandbox = task.build_sandbox()        # execution sandbox for one episode
    agent = task.build_agent()            # the configured solver
"""
