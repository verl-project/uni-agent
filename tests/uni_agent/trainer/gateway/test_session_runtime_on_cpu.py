...
from tests.uni_agent.trainer.support import FakeTokenizer, RecordingLLMClient
...
async def test_gateway_serving_runtime_round_robins_actors_across_alive_nodes(ray_runtime, monkeypatch):
    ...
    monkeypatch.setattr("uni_agent.trainer.gateway.runtime.ray.nodes", lambda: fake_nodes)
    ...
    monkeypatch.setattr("uni_agent.trainer.gateway.gateway.GatewayActor", _RecordingActor)
