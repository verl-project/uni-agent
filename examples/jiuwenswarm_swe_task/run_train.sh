...
# jiuwenswarm knobs (run_timeout/conda_env_path) and the tool-image mount are
# configured in TASK_CONFIG (task_config_jiuwenswarm.yaml).
TASK_CONFIG="${TASK_CONFIG:-examples/jiuwenswarm_swe_task/task_config_jiuwenswarm.yaml}"
