#!/usr/bin/env bash
# ============================================================================
# Bare / baseline RL training for Qwen3-Coder-30B-A3B-Instruct (SWE-Agent).
#
# This is the "no-tricks" baseline: GRPO + GSPO loss, fully-async rollout,
# bypass mode (old_log_prob = rollout_log_prob, the fully_async default),
# NO MoE router replay, NO decoupled-PPO / rollout-correction.
#
# For the tricked version (Decoupled PPO + Rollout Correction, and 30B MoE
# router replay) see: train_qwen3_coder_30b_tricks.sh
# ============================================================================
set -xeuo pipefail

project_name='Uni-Agent-SWE-Agent'
exp_name='GRPO-Qwen3-Coder-30B-Fully-Async-bare'
